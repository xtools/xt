...
xt_core_bool_t xt_net_star_client_system_connect
(xt_net_star_client_system_t *starclient);

xt_net_star_client_system_t *xt_net_star_client_system_create
(xt_case_list_t *star_arm_ips, unsigned short star_arm_port_min,
...
void xt_net_star_client_system_destroy
(xt_net_star_client_system_t *starclient);

xt_net_client_system_t *xt_net_star_client_system_get_client
(xt_net_star_client_system_t *starclient, int socket);

void xt_net_star_client_system_get_stats
(xt_net_star_client_system_t *starclient,
    xt_net_star_client_stats_t *starclient_stats);

void xt_net_star_client_system_process_messages
(xt_net_star_client_system_t *starclient);

xt_core_bool_t xt_net_star_client_system_register_engine
(xt_net_star_client_system_t *starclient, xt_net_engine_id_t engine_id,
    unsigned long message_type_count);

void xt_net_star_client_system_register_message_handler
(xt_net_star_client_system_t *starclient, xt_net_engine_id_t engine_id,
...
xt_core_bool_t xt_net_star_client_system_star_available
(xt_net_star_client_system_t *starclient);
