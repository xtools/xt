...
{
  return (xt_case_set_t *) xt_case_mbin_create(iobject,
...
{
  return xt_case_mbin_find((xt_case_mbin_t *) set, decoy_object);
}
...
{
  return xt_case_mbin_get_iobject((xt_case_mbin_t *) set);
}
...
{
  return xt_case_mbin_iterate_next((xt_case_mbin_t *) set);
}
    ...
    xt_core_object_get_as_string_f get_object_as_string)
{
  ...
  while ((object = xt_case_set_iterate_next(set))) {
    ...
    if (string) {
      ...
      xt_core_trace("get_object_as_string");
    }
  }
  printf("\n");
}
