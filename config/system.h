...
xt_core_bool_t xt_config_system_find_as_unsigned_long
(xt_config_system_t *system, char *name, unsigned long *value,
    unsigned long default_value);

xt_core_bool_t xt_config_system_find_as_unsigned_short
(xt_config_system_t *system, char *name, unsigned short *value,
    unsigned short default_value);

xt_core_bool_t xt_config_system_find_list_as_strings
(xt_config_system_t *system, char *name, xt_case_list_t **list);
